  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <Tab className="adhoc-filter-edit-tab" eventKey={EXPRESSION_TYPES.SIMPLE} title="Simple">
          ...
          </Tab>
          {
            ...
            <Tab className="adhoc-filter-edit-tab" eventKey={EXPRESSION_TYPES.SQL} title="Custom SQL">
